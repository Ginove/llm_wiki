  ...
  useEffect(() => {
    async function init() {
      try {
        ...
        const savedIngestConfig = await loadIngestConfig()
        if (savedIngestConfig) {
          useWikiStore.getState().setIngestConfig(savedIngestConfig)
        }
